...
let UserAddresses = class UserAddresses extends BaseModel_1.BaseModel {
    get status() {
...
], UserAddresses.prototype, "title", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: false,
    ...
    __metadata("design:type", String)
], UserAddresses.prototype, "address", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.INTEGER,
        defaultValue: 0,
...
], UserAddresses.prototype, "status", null);
UserAddresses = __decorate([
